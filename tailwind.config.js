...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Shoplytics brand colors with full palette
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
    ...
    function ({ addUtilities, addComponents, theme }) {
      ...
      addComponents({
        '.gradient-border': {
          ...
          'background': 'linear-gradient(white, white) padding-box, linear-gradient(135deg, rgb(59, 130, 246), rgb(147, 51, 234)) border-box',
        },
      });
    },
  ],
